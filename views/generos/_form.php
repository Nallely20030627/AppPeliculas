...
<div class="generos-form card">
    <div class="card-body">
        <h3 class="card-title mb-4"><?= $model->isNewRecord ? 'Crear Nuevo Género' : 'Actualizar Género' ?></h3>
        ...
        <div class="form-group text-center mt-4">
            <?= Html::submitButton($model->isNewRecord ? 'Crear Género' : 'Actualizar Género', [
