...
<div class="directores-form card">
    <div class="card-body">
        <h3 class="card-title mb-4"><?= $model->isNewRecord ? 'Crear Nuevo Director' : 'Actualizar Director' ?></h3>
        ...
        <div class="form-group text-center mt-4">
            <?= Html::submitButton($model->isNewRecord ? 'Crear Director' : 'Actualizar Director', [
